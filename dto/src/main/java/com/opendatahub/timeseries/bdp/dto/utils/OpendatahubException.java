...
public class OpendatahubException implements Serializable{
	...
	public OpendatahubException() {
	}
	
	public OpendatahubException(String name, String descString) {
		this.exceptionName = name;
		this.exceptionMessage = descString;
	}
	public OpendatahubException(Throwable exception) {
