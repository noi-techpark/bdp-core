...
create table edge (id int8 default nextval('edge_seq') not null, directed boolean default true not null, linegeometry GEOMETRY, destination_id int8, edge_data_id int8, origin_id int8, primary key (id));
create table event (id int8 default nextval('event_seq') not null, category varchar(255), created_on timestamp, description text, event_interval bytea, uuid varchar(255), location_id int8, meta_data_id int8, provenance_id int8, primary key (id));
...
create table type (id int8 default nextval('type_seq') not null, cname varchar(255) not null, created_on timestamp, cunit varchar(255), description varchar(255), rtype varchar(255), meta_data_id int8, primary key (id));
create table type_metadata (id int8 default nextval('type_metadata_seq') not null, created_on timestamp, json jsonb, type_id int8, primary key (id));
