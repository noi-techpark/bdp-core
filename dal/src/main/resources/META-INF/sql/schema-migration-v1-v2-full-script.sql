...
drop schema if exists intimev2 cascade;
create schema intimev2;
ALTER SCHEMA intimev2 OWNER TO bdp;
set search_path to public, intime, intimev2;

CREATE EXTENSION IF NOT EXISTS postgis SCHEMA intimev2;
CREATE EXTENSION IF NOT EXISTS pgcrypto SCHEMA intimev2;
\timing

set search_path to intimev2, public;
