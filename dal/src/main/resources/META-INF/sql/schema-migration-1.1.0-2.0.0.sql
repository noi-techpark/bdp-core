...
insert into intime.measurementhistory (created_on, timestamp, value, station_id, type_id, period, id) 
...
-- linkbasicdata
--------------------------------------------------------------------------------------------------------
insert into intime.edge (id, station_id, origin_id, destination_id, linegeometry, directed)
...
, ins2 as (
	insert into intime.edge (station_id, origin_id, destination_id)
